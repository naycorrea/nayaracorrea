...
<div class="highlight highlight-source-js"><pre><span class="pl-k text-red">const</span> <span class="pl-s1">anmol</span> <span class="pl-c1">=</span> <span class="pl-kos">{</span>
    ...
    <span class="pl-c1">currentFocus</span>: <span class="pl-s">"Comptetive Programming using C++"</span><span class="pl-kos">,</span>
